...
@Component({
  selector: 'app-product-card-basket-page',
  templateUrl: './product-card-basket-page.component.html',
  styleUrls: ['./product-card-basket-page.component.scss']
})
export class ProductCardBasketPageComponent implements OnInit {
